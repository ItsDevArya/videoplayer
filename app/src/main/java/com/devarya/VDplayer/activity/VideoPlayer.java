...
import static com.devarya.VDplayer.adapter.VideoAdapter.videoFolder;
...
public class VideoPlayer extends AppCompatActivity implements
        View.OnTouchListener, ScaleGestureDetector.OnScaleGestureListener, View.OnClickListener {
...
//    boolean isOpen= false;
    ...
    @Override
    public void onClick(View v) {
        int id = v.getId(); // assuming 'v' is your clicked view

        if (id == R.id.videoView_go_back) {
            onBackPressed();
        } else if (id == R.id.videoView_rewind) {
            videoView.seekTo(videoView.getCurrentPosition() - 10000);
        } else if (id == R.id.videoView_forward) {
            videoView.seekTo(videoView.getCurrentPosition() + 10000);
        } else if (id == R.id.videoView_play_pause_btn) {
    ...
    private void hideDefaultControls() {
        ...
        // to do this function will hide status and navigation when we click on screen
